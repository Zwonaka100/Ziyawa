...
function SheetContent({
  ...
  const sideClasses = {
    ...
    bottom: "data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom inset-x-0 bottom-0 border-t",
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 bg-background p-6 shadow-lg duration-300",
          sideClasses[side],
          className
        )}
        {...props}
