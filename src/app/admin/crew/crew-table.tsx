...
import type { CrewAdminRow } from '@/lib/admin/crew'
...
export function AdminCrewTable({ initialCrew }: { initialCrew: CrewAdminRow[] }) {
  // Seeded from the server render — no empty first paint, no fetch on mount.
  const [crew, setCrew] = useState<CrewAdminRow[]>(initialCrew)
